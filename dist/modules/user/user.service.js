...
exports.findAllUsers = exports.findUserById = exports.findUserByEmail = exports.createUser = exports.comparePassowrds = exports.hashPassword = void 0;
...
const createUser = (userInput) => __awaiter(void 0, void 0, void 0, function* () {
    const user = Object.assign(Object.assign({}, userInput), { password: hashPassword(userInput.password) });
